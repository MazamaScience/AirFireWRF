...
tempRaster <- raster::brick(WRFmet::sample_PNW$TSK)
windRaster <- raster::brick(WRFmet::sample_PNW$U10, WRFmet::sample_PNW$V10)
...
res <- round(mean(raster::res(WRFmet::sample_PNW)), digits = 2)
```
