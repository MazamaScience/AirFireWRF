...
tempRaster <- raster::brick(WRFmet::example_PNW$TSK)
windRaster <- raster::brick(WRFmet::example_PNW$U10, WRFmet::example_PNW$V10)
...
res <- round(mean(raster::res(WRFmet::example_PNW)), digits = 2)
```
