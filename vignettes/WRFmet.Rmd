...
The **WRFmet** package allows users to download, read, and visualize the 
...
* `plot_raster()` - Plots a single _RasterLayer_.
* `plot_standard()` - Plots a _RasterLayer_, _SpatialPolygonsDataFrame_, 
